...
async def test_bigquery_toolset_tools_default():
  ...
  assert isinstance(toolset._tool_config, BigQueryToolConfig)  # pylint: disable=protected-access
  assert toolset._tool_config.__dict__ == BigQueryToolConfig().__dict__  # pylint: disable=protected-access
